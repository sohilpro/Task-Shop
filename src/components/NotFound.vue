<template>
  <div class="container1 container1-star">
  ...
  <div class="container1 container1-bird">
    <div class="bird bird-anim">
      <div class="bird-container1">
    ...
    <div class="container1-title">
      ...
      <router-link to="/" class="btn1">Go back</router-link>
    </div>
  </div>
</template>
